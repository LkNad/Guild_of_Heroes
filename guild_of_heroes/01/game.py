...
WIN_WIDTH = 1300  # Ширина создаваемого окна
        ...
        for e in pygame.event.get():  # Обрабатываем события
            ...
            if e.type == pygame.MOUSEBUTTONDOWN:
                ...
                if exit_button.is_hovered(mouse_pos):
                    from menu import MenuWindow  # Импортируем, чтобы двойной импорт не мешал

                    menu_window = MenuWindow()  # Убираем self
                    menu_window.run()
                    pygame.quit()  # Завершаем Pygame перед выходом из игры
                    sys.exit()
